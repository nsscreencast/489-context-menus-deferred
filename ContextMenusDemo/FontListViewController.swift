...
class FontListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, contextMenuConfigurationForRowAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        ...
        let preview: () -> UIViewController = {
            let previewVC = self.storyboard!.instantiateViewController(identifier: "FontPreviewController") as! FontPreviewController
            previewVC.fontFamily = font.familyName
            return previewVC
        }
        
        return UIContextMenuConfiguration(identifier: nil, previewProvider: preview) { _ -> UIMenu? in
            ...
            let isFavorite = self.favorites.contains(font.familyName)
